    ...
    <>
      <div className="w-full md:max-w-3xl md:p-4 bg-white dark:bg-gray-800 rounded-md mx-48 shadow-md mb-4">
        ...
        <form onSubmit={handleSubmit} className="flex justify-between">
          ...
          <button
            type="submit"
            className="bg-blue-400 hover:bg-blue-500 dark:bg-blue-600 hover:dark:bg-blue-800 rounded-md text-white font-bold p-3 m-3 border-none transition-all duration-300 ease-in-out"
          >
            Add Task
          </button>
        </form>
